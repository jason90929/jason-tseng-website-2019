...
class Portfolio extends Component {
  render () {
    return (
      <article>
        <h3>COBINHOOD public API test (2018/11)</h3>
        <p>
          <a
        ...
        <ul>
          <li>D3.js Techan to build a candle chart</li>
          <li>Use Websocket to get latest data</li>
          <li>Build with Vue.js</li>
        </ul>

        <hr/>

        <h3>TourRing (2018/06~present) in iStaging products</h3>
        <p>
          <a
        ...
        <ul>
          <li>Vue, AFrame</li>
          <li>Agora for webRTC SDK</li>
          <li>To make a call with agent on website</li>
          <li>Landing page for builders</li>
          <li>Need to handle a page that in app mode</li>
          <li>90%~95% coding in whole project by me</li>
        </ul>

        <h3>3D Dollhouse (2017/12~2018/04) in iStaging products</h3>
        <p>
          <a
        ...
        <ul>
          <li>React static webpage</li>
          <li>A-Frame and three.js based</li>
          <li>90%~95% coding in whole project by me</li>
        </ul>

        <h3>Live Tour (VR Viewer) (2017/05~present) in iStaging products</h3>
        <p>
          <a
        ...
        <ul>
          <li>Vue, Krpano</li>
          <li>Krpano for 3d scene panorama viewing</li>
          <li>NodeJS express for simple SEO rendering</li>
          <li>85%~90% coding in whole project by me</li>
        </ul>

        <h3>VR Editor (2017/05~present) in iStaging products</h3>
        <p>
          <a
        ...
        <ul>
          <li>CMS website</li>
          <li>Serverless service via Firebase</li>
          <li>AFrame for panorama viewing</li>
          <li>50%~55% coding in whole project by me</li>
        </ul>

        <hr/>

        <h3>Moldex3D (2017/01) in Nong Design (弄弄設計)</h3>
        <p>
          <a
        ...
        <ul>
          <li>Gulp generated HTML</li>
          <li>WordPress PHP for backend server</li>
        </ul>

        <h3>LIZARD (2016/12~2017/01) in Nong Design (弄弄設計)</h3>
        <p>
          <a
        ...
        <h3>弄弄設計 (2016/11~2017/01) in Nong Design (弄弄設計)</h3>
        <p>
          <a
        ...
        <ul>
          <li>React based</li>
          <li>WordPress for backend JSON API</li>
        </ul>

        <h3>CNEWS 匯流新聞網 (2016/09~2017/01) in Nong Design (弄弄設計)</h3>
        <p>
          <a
        ...
        <h3>紘樂網站 (2016/09~2017/01) in Nong Design (弄弄設計)</h3>
        <p>
          <a
        ...
        <h3>Girlfie. (2016/06~2016/08) in Nong Design (弄弄設計)</h3>
        <p>
          <a
        ...
        <h3>ctop 圖資網 (2016/07~2016/10) in Nong Design (弄弄設計)</h3>
        <p>
          <a
        ...
        <ul>
          <li>pure JavaScript, CSS and HTML</li>
        </ul>

        <h3>台達電子 (2016/05~2016/11) in Nong Design (弄弄設計)</h3>
        <p>
          <a
        ...
        <h3>My Wedding (2016/04~2016/12) in Nong Design (弄弄設計)</h3>
        <p>
          <a
        ...
        <h3>Personal website (this is 2 years ago)</h3>
        <p>
          <a
        ...
        <ul>
          <li>React based static page</li>
          <li>Github hosted website</li>
          <li>A-Frame based 3D module</li>
        </ul>

        <h3>廷廷鋼琴窩團購網 (2016/09~2016/11) in Case job</h3>
        <p>
          <a
        ...
        <h3>Gopapala (2016/08) in Case job</h3>
        <p>
          <a
